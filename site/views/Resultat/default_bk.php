...
<form method="GET" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    ...
    <select id="ar" Name="arstall" Size="Number_of_options" onchange="f_valg" value="<?php echo $arstall ?>" onchange="f_valg()">
        <?php
        while ($nr < count($mes)) : {
                //echo $mes[$nr++].'<br>';
...
År:  <select id="ar" Name="arstall" Size="Number_of_options" onchange="f_valg()" value="<?php echo $arstall ?>" onchange="f_valg()">
  ...
  <option value="2021" <?php if ($arstall == "2021") echo " selected" ?>> 2021 </option>
  <option value="2020" <?php if ($arstall == "2020") echo " selected" ?>> 2020 </option>
  <option value="2019" <?php if ($arstall == "2019") echo " selected" ?>> 2019 </option>
  <option value="2018" <?php if ($arstall == "2018") echo " selected" ?>> 2018 </option>
  <option value="2017" <?php if ($arstall == "2017") echo " selected" ?>> 2017 </option>
  <option value="2016" <?php if ($arstall == "2016") echo " selected" ?>> 2016 </option>
  <option value="2015" <?php if ($arstall == "2015") echo " selected" ?>> 2015 </option>
  <option value="2014" <?php if ($arstall == "2014") echo " selected" ?>> 2014</option>
  <option value="2013" <?php if ($arstall == "2013") echo " selected" ?>> 2013 </option>
  <option value="2012" <?php if ($arstall == "2012") echo " selected" ?>> 2012 </option>
</select-->
    Periode: <select id="periode" Name="periodenavn" Size="Number_of_options" onchange="f_valg()">
        <option value="Januar" <?php if ($periodenavn == "Januar") echo " selected" ?>> Januar </option>
        <option value="Februar" <?php if ($periodenavn == "Februar") echo " selected" ?>>Februar</option>
        <option value="Mars" <?php if ($periodenavn == "Mars") echo " selected" ?>>Mars </option>
        <option value="April" <?php if ($periodenavn == "April") echo " selected" ?>>April </option>
        <option value="Mai" <?php if ($periodenavn == "Mai") echo " selected" ?>>Mai </option>
        <option value="Juni" <?php if ($periodenavn == "Juni") echo " selected" ?>>Juni </option>
        <option value="Juli" <?php if ($periodenavn == "Juli") echo " selected" ?>>Juli </option>
        <option value="August" <?php if ($periodenavn == "August") echo " selected" ?>>August </option>
        <option value="September" <?php if ($periodenavn == "September") echo " selected" ?>>September </option>
        <option value="Oktober" <?php if ($periodenavn == "Oktober") echo " selected" ?>>Oktober </option>
        <option value="November" <?php if ($periodenavn == "November") echo " selected" ?>>November </option>
        <option value="Desember" <?php if ($periodenavn == "Desember") echo " selected" ?>>Desember </option>
    </select>
...
/*
        ...
        $query = 'CALL proc_resrapport3(' . $_GET["regnar"] . ');';
        $db->setQuery((string) $query);
        $db->loadObject();
        ...
        $messages = $db->loadObjectList();
      /*  $end_time = time();
        $difftime =  $end_time - $_SESSION['start_time'];
        echo 'medgått tid: ' . $difftime . '<br>';
* /
        $options  = array();
        ...
        if ($messages) {
            foreach ($messages as $message) {
                ...
                if ($message->niva > 1) echo '<tr><td colspan="8">-------------------------------------------------------------------------------------------------------------------------------------</td></tr>';
...
*/?>
        ...
        {
            if ($navn == 'Januar') return '1';
            elseif ($navn == 'Februar') return '2';
            elseif ($navn == 'Mars') return '3';
            elseif ($navn == 'April') return '4';
            elseif ($navn == 'Mai') return '5';
            elseif ($navn == 'Juni') return '6';
            elseif ($navn == 'Juli') return '7';
            elseif ($navn == 'August') return '8';
            elseif ($navn == 'September') return '9';
            elseif ($navn == 'Oktober') return '10';
            elseif ($navn == 'November') return '11';
            elseif ($navn == 'Desember') return '12';
        }
        ?>
