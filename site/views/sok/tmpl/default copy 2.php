...
if ($value > '')
	$sql = 'select Bilagsart,Bilag,Dato,debet,kredit,belop,Tekst,kontoinfo from ' . $value . '.qo7sn_regn_hist where debet=4010;'; // and regnskapsar=2022 and Periode="februar" order by dato;';
else
...
if ($value > '')
	$sql = 'select * from ' . $value . '.qo7sn_regn_kto order by Ktonr;';
else
...
if ($value > '')
	$sql = 'select * from ' . $value . '.qo7sn_regn_perioder order by nr;';
else
...
if ($value > '')
	$sql = 'select * from ' . $value . '.qo7sn_regn_regnskapsar order by regnskapsar desc;';
else
...
if ($value > '')
	$sql = 'select *  from ' . $value . '.qo7sn_regn_firma;';
else
