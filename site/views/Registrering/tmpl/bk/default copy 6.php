...
if ($result = mysqli_query($link, $sql)) {
    ...
    <form method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <table style=" margin-left: 5px;" id="e" border="0" cellspacing="1" cellpadding="1">
            ...
            <td><input class="fff" type="text" id=3 name="debet" style=" width:50px;" onclick="finn_kto(0)"
            ...
            <td><input class="fff" type="text" id=4 style=" width:50px;" class="no-outline" onclick="finn_kkto(0)"
            ...
            <td><input class="fff" type="text" id=id_tekst style=" width:200px;"
...
*/
 ...
 //      async 
        function UpdateRecord(ref, bilagsnr, buntnr, mode) {
         //   console.log("updateRecord " + ref + " :" + bilagsnr + " :" + buntnr + " :" + mode);
            ...
            console.log("UpdateRecord vv: |" + vv + "| ref: " + ref);   
