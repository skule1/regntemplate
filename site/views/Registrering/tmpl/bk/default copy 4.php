...
//             $v = $i - 1;
//     endwhile;
echo 'regnskapsår: ' . $regnskapsar . '<br>';
?>
...
if ($result = mysqli_query($link, $sql)) {
    ...
    <form method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <table style=" margin-left: 5px;" id="e" border="0" cellspacing="1" cellpadding="1">
            ...
            ?>
            <td><input class="fff" type=" text" id=5 class="no-outline" style=" width:100px;"
                    onkeydown="belop('<?php echo $modus ?>')">
            </td>
            <td><input class="fff" type="text" id=6 style=" width:200px;"
...
*/
    ...
    <script type="text/javascript">
        ...
        let r1 = document.getElementById(id_kredit);
        if (r1) {       
        ...
        async function UpdateRecord(ref, bilagsnr, buntnr, mode) {
            ...
            console.log(dato, art, debet, kredit, belop);
            if (event.key == 'Enter') {
        ...
        */
        ...
        async function finn_kto(i) { //i=0: onclick, i=1: onchange
            ...
            let kto = document.getElementById(3);
            if (kto) {
                kto = kto.value;
            }
            let dato = document.getElementById(2);
            if (dato) {
                dato = dato.value;
            }
            ...
            console.log('dato: ', dato, year, month);
            let r = document.getElementById(id_debet);
            if (r) {
                if (i == 0) {
                    document.getElementById(id_debet).value = ' ';
                    kto = '';
                }
            }
            // if (kto === undefined)
        ...
        function datokonv4(regnskapsar) {
            ...
            let debet = '';
            let el = document.getElementById(id_debet);
            if (!el) {
                debet = '';
            ...
            let el1 = document.getElementById(id_kredit);
            if (!el1) {
                kredit = '';
            } else if (el1.value === "" || el1.value == null) {
                kredit = '';
            } else {
                kredit = el1.value;
            };
