    ...
    if (!$transer) {
        ...
        valg <select id="valg_ar" Name="valg_ar" onchange="endre_ar()">
            ...
            foreach ($regnskapsarliste as $regnskapsar1) {
                ...
                if ($regnskapsar1 == $regnskapsar)
                    echo '<option value=' . $regnskapsar1 . ' selected>' . $regnskapsar1 . '</option>';
                else
                    echo '<option value=' . $regnskapsar1 . '>' . $regnskapsar1 . '</option>';
            }
    ...
    <!-- <form method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <table style=" margin-left: 5px;" id="e" border="0" cellspacing="1" cellpadding="1"> -->
            ...
            <?php
             ...
             echo '<td></td><td  style="text-align:right;"> <input type="text" id="bilagsart' . $message->Ref . '"  onclick="btn(' . $message->Ref . ')"  onchange="updatefield(' . $message->Ref . ')" style=" width:30px; border-width:0px; direction: rtl;" value="' . $message->Bilagsart . '"></td>'
                . '<td  style="text-align:right;"> <input type="text" id="dato' . $message->Ref . '"  onclick="btn(' . $message->Ref . ')"  onchange="updatefield(' . $message->Ref . ')" style=" width:115px; border-width:0px; direction: rtl;"  value="' . $message->Dato . '"></td>'
                . '<td  style="text-align:right;"> <input type="text" id="debet' . $message->Ref . '"   onclick="btn(' . $message->Ref . ')" onchange="updatefield(' . $message->Ref . ')" style=" width:50px; border-width:0px; direction: rtl;"   value="' . $message->debet . '"></td>'
                . '<td  style="text-align:right;"> <input type="text" id="kredit' . $message->Ref . '"  onclick="btn(' . $message->Ref . ')"  onchange="updatefield(' . $message->Ref . ')" style=" width:50px; border-width:0px; direction: rtl;"  value="' . $message->kredit . '"></td>';
            ...
            <td><input class="fff" type="text" id=1 style=" width:30px;" onkeydown="list_art()" onclick="list_art()"
                    onchange="list_art()"> </td>
            <!--td><input type="text" id=1 style=" width:30px;" onkeydown="finn_kto()"   > </td-->
            <td><input class="fff" type="text" placeholder="DD.MM.YYYY" name="Dato" id=2 style=" width:115px;"
                    onchange="datokonv4(<?php echo $regnskapsar ?>)" </td>

            <td><input class="fff" type="text" id=id_debet name="debet" style=" width:50px;" onclick="finn_kto(0)"
            ...
            <td><input class="fff" type="text" id=id_kredit style=" width:50px;" class="no-outline"
                    onclick="finn_kkto(0)" onkeydown="finn_kkto(1)"> </td>
            <?php if ($modus == 'valuta') {
                ?>
            ...
            ?>
            <td><input class="fff" type=" text" id=id_belop class="no-outline"
                    onkeydown="belop('<?php echo $modus ?>')">
            </td>
            <td><input class="fff" type="text" id=id_tekststyle=" width:200px;"
...
*/
    ...
    <script type="text/javascript">
        ...
        async function UpdateRecord(ref, bilagsnr, buntnr, mode) {
            ...
            // } else
            vv = document.getElementById(id_tekst).value;
            const bk = vv;
            console.log("UpdateRecord vv: |" + vv + "| ref: " + ref, bk);
            const sistepost = <?php echo $sistepost ?>;
            if ((vv == ' ') || ((vv == '') && (event.key == ' '))) {
