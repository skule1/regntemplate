    ...
    <script type="text/javascript">
        ...
        async function hent_kto1(kto, i) { // henter ktoinfo ved  å klikke på liste
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    //      jQuery.ajax({
                    type: "POST",
                    url: "index.php?option=com_regn&task=registrering.finn_konto",
                    //               url: "/components/com_regn/views/Registrering/tmpl/update.php",
                    //                url: "/components/com_regn/views/Registrering/tmpl/update.php",
                    //     url: "/components/com_regn/views/Bilagsart/tmpl/update.php",
                    data: ({
                    ...
                    cache: false,
                    success: function(tekst) {
                        console.log('AAAAAAAAAAAAAAAAAAAAAtekst hent_kto1: ' + tekst);
                        // console.log('BBBBBBBBBBBBBBBBBBBBBBBBB');
                        obj3 = JSON.parse(tekst);
                        // console.log('obj3: ', obj3);
                        // console.log('hent_kto1AA: ' + document.getElementById("3").value);
                        if (tekst == null) console.log('NULL1');
                        if (tekst == 'null') {
                            ///        console.log('NULL2');

                            var gg =
                                '<table style=" margin-left: 20px;" border="0" cellspacing="0" cellpadding="0"><tr><th style="text-align:right;width:100px; padding: 0px 10px 0px 0px;"  >Debet</th><th style="text-align:left;width:150px; padding: 0px 0px 0px 0px;">Navn</th></tr><tr>';
                            gg = gg +
                                '<tr><td style="text-align:right; border-width:0px; width:150px; padding: 0px 10px 0px 0px;">' +
                                kto + '</td><td>' + 'navn' + '</td></tr>';
                            gg = gg + '</table>';
                            // document.getElementById("333").innerHTML = gg;
                            document.getElementById("db").innerHTML = gg;
                            document.getElementById("3").value = kto;
                            //      console.log("ktonr**********: " + kto);
                            //    document.getElementById("4").focus();
                        }
                        if (tekst == '') console.log('NULL3');
                        if (tekst != 'Ugyldig dato' && tekst != 'null') {

                            // console.log('tekst hent_kto1a: ' + tekst);
                            // console.log('tekst hent_kto1b tekst ferdig')

                            // console.log("obj3: ".obj3);
                            // console.log("Kto: " + obj3.kto);
                            // console.log("Navn: " + obj3.Navn);
                            // console.log("belop: " + obj3.belop);
                            // console.log("budsjett: " + obj3.budsjett);
                            // console.log("hittil: " + obj3.hittil);
                            // console.log("resbalN: " + obj3.resbal);
                            // //             console.log("resbalU: " + obj3.resbal.toUpperCase());
                            // console.log("sum: " + obj3.hittil);
                            document.getElementById("3").value = obj3.Ktonr;
                            let nokpenger = new Intl.NumberFormat('no-NB', {
                                style: 'currency',
                                currency: 'NOK',
                            });
                            // var disp = obj3.budsjett - obj3.hittil;
                            var gg =
                                '<table  style=" margin-left: 20px;" border="0" cellspacing="0" cellpadding="0"><tr><th style="text-align:right; padding: 0px 10px 0px 0px;" width="100" >Debet</th><th width="150">Navn</th></tr><tr>' +
                                '<tr><td style="text-align:right; border-width:0px;  padding: 0px 10px 0px 0px;">' +
                                obj3.Ktonr + '</td>' +
                                '<td>' + obj3.Navn + '</td></tr>';
                            // console.log('obj3.resbal ' + obj3.ResBal);
                            // console.log(obj3);

                            if ((obj3.resbal != null) && (obj3.resbal.toUpperCase() == 'R')) {
                                gg = gg +
                                    '<tr><td style="text-align:right; border-width:0px;  padding: 0px 10px 0px 0px;">Brukt periode: </td>' +
                                    '<td  style="text-align:right;" >' + nokpenger.format(obj3.belop) +
                                    //     '<td  style="text-align:right;" >' + obj3.belop +
                                    '</td></tr>' +
                                    ...
                                    '<td style="text-align:right;">' + nokpenger.format(obj3.budsjett) +
                                    '</td></tr>' +
                                    '<tr><td style="text-align:right; border-width:0px;  padding: 0px 10px 0px 0px;">Hittil Budsjett: </td>' +
                                    '<td style="text-align:right;">' + nokpenger.format(obj3.sumbudsj) +
                                    '</td></tr>' +
                                    '<tr><td style="text-align:right; border-width:00px; padding: 0px 10px 0px 0px;">Hittil brukt: </td>' +
                                    '<td style="text-align:right;">' + nokpenger.format(obj3.hittil) +
                                    '</td></tr>' +
                                    '<tr><td style="text-align:right; border-width:0px;  padding: 0px 10px 0px 0px;">Disponibelt: </td>' +
                                    '<td style="text-align:right;">' + nokpenger.format((obj3.sumbudsj) - (obj3.hittil)) + '</td></tr>';
                            } else {
                                gg = gg +
                                    '<tr><td  style="text-align:right; border-width:0px;  padding: 0px 10px 0px 0px;">Saldo: </td>' +
                                    '<td    style="text-align:right;" >' + nokpenger.format(obj3.belop) +
                                    '</td></tr>';
                            }
                            gg = gg + '</table>';
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    ...
                    success: function(tekst) {
                        // console.log(tekst);
                        if (tekst == null) console.log('NULL1');
                        if (tekst == 'null') console.log('NULL2');
                        if (tekst == '') console.log('NULL3');
                        if (tekst != 'Ugyldig dato' && tekst != 'null') {
                            // console.log('tekst hent_kkto1: ' + tekst);
                            obj3 = JSON.parse(tekst);
                            // console.log(obj3);
                            resolve(obj3);
                            // console.log("resbalN: " + obj3.ResBal);
                            ...
                            // console.log(obj3);
                            // console.log('OBJ3:  ' + obj3.Ktonr + '  ' + obj3.Navn);
                            if (!(typeof obj3.periode === 'undefined' || obj3.periode === null))
                                console.log("finnes ");
                            else console.log("finnes ikke");
                            // console.log("per: " + obj3.periode);
                            //    document.getElementById(id_kredit).value= obj3.Ktonr;

                            document.getElementById(id_kredit).value = obj3.Ktonr;

                            //          document.getElementById("3").value = obj3.kto;
                            let nokpenger = new Intl.NumberFormat('no-NB', {
                                style: 'currency',
                                currency: 'NOK',
                            });
                            var gg =
                                '<table  style=" margin-left: 20px;" border="0" cellspacing="0" cellpadding="0"><tr><th style="text-align:right; padding: 0px 10px 0px 0px;" width="150" >Kreditt</th><th width="150">Navn</th></tr><tr>' +
                                '<tr><td style="text-align:right; border-width:0px;  padding: 0px 10px 0px 0px;">' +
                                obj3.Ktonr + '</td>' +
                                '<td>' + obj3.Navn.substring(0, 15) + '</td></tr>';
                            if (!(typeof obj3.periode === 'undefined' || obj3.periode === null)) {
                                var disp = obj3.budsjett - obj3.hittil;
                                gg = gg +
                                    '<tr><td style="text-align:right; border-width:0px;  padding: 0px 10px 0px 0px;">Brukt periode: </td>' +
                                    ...
                                    '<td style="text-align:right;">' + nokpenger.format(obj3.budsjett) +
                                    '</td></tr>' +
                                    '<tr><td style="text-align:right; border-width:0px;  padding: 0px 10px 0px 0px;">Htiil Budsjett: </td>' +
                                    '<td style="text-align:right;">' + nokpenger.format(obj3.sumbudsj) +
                                    '</td></tr>' +
                                    '<tr><td style="text-align:right; border-width:00px; padding: 0px 10px 0px 0px;">Hittil brukt: </td>' +
                                    '<td style="text-align:right;">' + nokpenger.format(obj3.hittil) +
                            ...
                            /*
                                                var gg =
                                                    '<table  border="0" cellspacing="0" cellpadding="0"><tr><th style="text-align:right; padding: 0px 10px 0px 0px;" width="100" >Debet</th><th width="150">Navn</th></tr><tr>';
                                                gg = gg +
                                                    '<tr><td style="text-align:right; border-width:0px;  width:150px; padding: 0px 10px 0px 0px;">' +
                                                    obj3.Ktonr + '</td><td>' + obj3.Navn + '</td></tr>' +
                                                    '<tr><td style="text-align:right; border-width:0px;  width:150px; padding: 0px 10px 0px 0px;">Budsjett: </td><td width="150" >' +
                                                    obj3.budsjett + '</td></td>' +
                                                    '<tr><td style="text-align:right; border-width:0px; width:150px; padding: 0px 10px 0px 0px;">Hittil: </td><td width="150" >' +
                                                    obj3.hittil + '</td></td>' +
                                                    '<tr><td style="text-align:right; border-width:0px;  width:150px; padding: 0px 10px 0px 0px;">Disponibelt: </td>' +
                                                    '<td width="150"  >' + disp + '</td></td>';
                                                gg = gg + '</table>';
                            ...
                            */
                            ...
                            // console.log("focus til kredit " + i + '  ' + event.key);
                            //     console.log(' event.key: ' + eventkey);
                            if (i != 4) {
                                if ((i == 0)) //&& (event.key == 'Enter'))
                                    document.getElementById(id_belop).focus();
                                else if ((i == 0) && !(event.key == 'Enter'))
                                    document.getElementById(id_kredit).focus();
                            }
                            // else
                            document.getElementById(id_tekst).focus();
        ...
        function hent_kto(arg) {
            ...
            jQuery.ajax({
                ...
                success: function(tekst) {
                    ...
                    let gg =
                        '<table  style=" margin-left: 20px;" border="0" cellspacing="0" cellpadding="0"><tr><th style="text-align:right; width:100px; padding: 0px 10px 0px 0px;" >Kredit</th><th style="text-align:left; width:150px; ">Navn</th></tr><tr>';


                    obj2 = JSON.parse(tekst);
                    let u = 1;
                    if (obj2.length == undefined) u = 0;
                    console.log('u: ', u, obj2);
                    if (u === 0) {
                        let disp = obj2.budsjett - obj2.belop;
                        //          document.getElementById("id_debet").value=obj2.Ktonr;

                        console.log(1, u, obj2.Ktonr);
                        ...
                        gg = gg +
                            '<tr> <td >  <input type="text"  style="text-align:right; border-width:0px;  width:100px; padding: 0px 10px 0px 0px;"' +
        ...
        function hent_kkto(arg) {
            ...
            jQuery.ajax({
                ...
                success: function(tekst) {
                    ...
                    var gg = '<table  style=" margin-left: 20px;" border="0" cellspacing="0" cellpadding="0"><tr><th style="text-align:right; width:100px; padding: 0px 10px 0px 0px;" >Debet</th><th style="text-align:left; width:150px; ">Navn</th></tr><tr>';
                    ...
                    // if (!(obj2.budsjett == undefined)) {
                    //     '<tr><td style="text-align:right; border-width:0px; width:150px;  padding: 0px 10px 0px 0px;">Budsjett: </td><td>' +
                    //     obj2.budsjett + '</td></tr>' +
                    //         '<td style="text-align:right; border-width:0px; width:150px; padding: 0px 10px 0px 0px;">Hittil: </td><td >' +
                    //         obj2.hittil + '</td></td>' +
                    //         '<tr><td style="text-align:right; border-width:0px;  width:150px; padding: 0px 10px 0px 0px;">Disponibelt: </td>' +
                    //         '<td >' + disp + '</td></tr>';
                    }
        ...
        // var gg =
        //     '<table style=" margin-left: 20px;"  border="0" cellspacing="2" cellpadding="2"><tr><th width="200" >Kto</th><th width="150">Navn</th></tr><tr>';
        // gg = gg +
        //     ' <td >  <input type="text"  style="text-align:right; border-width:0px; width:150px;"  id="oo"  ' +
        //     ' <td > <input type="text"  style="text-align:left; border-width:0px; width:150px;" id="kk" </td></tr>';
        ...
        //  document.getElementById("db").innerHTML = gg;
        // /*
        //             document.getElementById("dinfo").innerHTML = 'Konto: ' + $i;
        ...
        */
                 ...
                 //   if (u != 0) 
                    {
                        ...
                        if (!(obj2.budsjett == null)) {
                            ...
                            for (let i = 0; i < obj2.length; i++) {
                                gg = gg +
                                    '<tr> <td >  <input type="text"  style="text-align:right; border-width:0px;  width:150px; padding: 0px 10px 0px 0px;"' +
                                    'id="' + i + 'oo" value="' + obj2[i].Ktonr + '"  onclick="hent_kkto(' + obj2[i].Ktonr + ',' + i + ')"></td>' +
                                    ' <td > <input type="text"  style="text-align:left; border-width:0px; width:100px; padding: 0px 10px 0px 0px;" ' +
                                    'id="' + i + 'kk" value="' + obj2[i].Navn + '" onclick="hent_kkto(' + obj2[i].Ktonr + ')" ></td></tr>';
                            }
                        }
                        gg = gg + '</table>';
        ...
        function datokonv4(regnskapsar) {
            ...
            // console.log(p, ' ', q, ' ', dag, ' ', mnd, ' ', ar, ' ', dato);;

            if (debet != '') hent_kto1(debet, 4);
            if (kredit != '') hent_kkto1(kredit, 5);


            console.log('|', debet, '|', debet, '|', belop);
            if (debet == '') {
                finn_kto();
                document.getElementById(id_debet).focus();
            } else if (kredit == '') {
                finn_kkto();
                document.getElementById(id_kredit).focus();
            } else if (belop == '') document.getElementById(id_belop).focus();
